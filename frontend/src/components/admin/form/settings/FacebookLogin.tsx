...
export type FacebookLoginType = z.infer<typeof facebookLoginSchema>

type TProps = {
  settingsKey: string
  initialValues?: FacebookLoginType | undefined
  refetch?: () => void
}

const FacebookLoginForm = ({ settingsKey, initialValues, refetch }: TProps) => {
  const {
    control,
    handleSubmit,
    formState: { errors, isSubmitting }
  } = useForm<FacebookLoginType>({
    resolver: zodResolver(facebookLoginSchema),
    defaultValues: {
      ...initialValues,
            ...
            <Controller
              ...
              render={({ field }) => (
                <CustomInput
                  ...
                  placeholder='Enter Facebook redirect URL'
