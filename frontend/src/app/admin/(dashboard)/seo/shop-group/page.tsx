...
export default function ProductGroupSeoPage() {
  ...
  // Support both legacy array response and new `{ productGroups, pagination }` shape
  const { data: groupsData, loading: loadingGroups } = useAsync<{
  ...
  // Extract groups array, handling both response shapes (array or { productGroups, pagination })
  const groups: ProductGroup[] = Array.isArray(groupsData?.data)
    ? (groupsData?.data as ProductGroup[])
        ...
        <div className='bg-card border rounded-lg p-6'>
          ...
          {loadingGroups ? (
            ...
            <CustomSelect
              ...
              staticOptions={groups.map((group: ProductGroup) => ({
